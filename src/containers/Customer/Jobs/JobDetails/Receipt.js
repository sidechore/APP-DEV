...
export default class Receipt extends Component {
    ...
    renderSentText(item) {
        ...
        if(item.type==="refer")
        {
            <View style={{marginTop:30,width:"90%",height:200,backgroundColor:"white",borderRadius:5,borderTopColor:"red",borderWidth:2}}>
            </View>
        }
    }
    checkEmail(){}
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                {this.state.Message && <FlatList style={{width: "100%", marginBottom: 10, marginTop: 10}}
