            ...
            <View style={styles.container}>
                ...
                <ScrollView>
                    <View style={{flexDirection: "column", width: "100%", backgroundColor: "white"}}>
                        <View style={{
                            width: "100%", height: 250, backgroundColor: "white", marginTop: 20,
                                ...
                                <View style={{
                                    ...
                                    <View style={{width: "10%"}}>
                                        <Image source={require("../../../../assets/images/mscard.png")}
                                               style={{
                                                   resizeMode: "contain", width: 35, height: 35,
                                                   marginStart: 15
                                               }}
                            ...
                            <View
                                style={{height: 1, backgroundColor: "#DADADA", marginStart: 25, marginEnd: 25,}}></View>
                            <View
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <Text style={{
                                    color: "black",
                                    fontSize: 12
                                }}>{"You will not charged until your job is completed."}</Text>
                                <Text style={{
                                    color: "black",
                                    fontSize: 12
                                }}>{"A 7.5% Trust & Support fee will be added to your subtotal"}</Text>
                ...
                <Modal isVisible={this.state.isModalVisible}
                    ...
                    <View style={{justifyContent: "center", alignItems: "center",}}>
                        <View style={{
                            flexDirection: "column", backgroundColor: "white", height: 220, borderRadius: 5
                            ...
                            <Text style={{
                                ...
                                fontWeight: "bold",
                                marginBottom: 15
                            }}>{"You have booked John Brown"}</Text>
                            <Text
                                style={{color: "black", fontSize: 13}}>{"Thanks for booking. John will contact"}</Text>
                            <Text style={{
                                color: "black",
                                fontSize: 13,
                                marginBottom: 50
                            }}>{"you within next 24 hours."}</Text>
