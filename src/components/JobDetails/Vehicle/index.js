    ...
    render() {
        return (
            <View style={{
                ...
                <Text style={{color: "red", fontSize: 18}}>{"Does this job require a car or truck?"}</Text>
                <View style={{
                    flexDirection: "row",
                    ...
                    <View style={{flexDirection:"column",}}  >
                        <View style={{flexDirection:"row",margin:15}}>
                            ...
                            />
                            <View style={{flexDirection:"column"}} >
                                <Text  style={{marginStart:10,color:"black",fontSize:16}} >{"No vehicle needed"}</Text>
                        ...
                        <View style={{flexDirection:"row",margin:15}}>
                            ...
                            />
                            <View style={{flexDirection:"column"}} >
                                <Text  style={{marginStart:10,color:"black",fontSize:16}} >{"A car is needed"}</Text>
                        ...
                        <View style={{flexDirection:"row",margin:15}}>
                            ...
                            />
                            <View style={{flexDirection:"column"}} >
                                <Text  style={{marginStart:10,color:"black",fontSize:16}} >{"A truck is needed"}</Text>
                            </View>
                        </View>
